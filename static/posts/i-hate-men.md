...
tags: "computing education, feminism"
date: 2026-08-26
---
...
I used to laugh it off or ignore these sexists remarks, but every time after the fact, looking back, I would hate myself for it - hate that I allowed it to happen, and hate that I was in some sense, contributing to what I want to fight against.

Quite frankly, I still don't know how to react to such small remarks all that well, and I think my current defense mechanism is to make fun of guys at the slightest hint of sexism, but obviously that's not ideal. I hope to grow in terms of confidence such that I can openly call out a sexist remark without injecting it with humour, in an attempt to lighten the mood, so as to make it clear I will not tolerate any sort of this kind of comments.
...
When you're one of the few girls in the room, or for me at least, its hard to not feel like everyone will be using your performance / actions to judge the rest of your gender, in a sense. It is unfair to think or feel it, but several times I've felt this weird self-imposed pressure of carrying the weight of an entire gender's image during events or competitions.
...
I think the concerns I have with the current system and the environment for girls starting in computing can be broken down into a few parts:

Firstly, stereotypes. I've never experienced this personally, but I have seen around me how the stereotype of stinky boys being portrayed as the average programmer can deter girls from starting. Because if I don't want to grow into someone like that, why would I choose to start? This, I think is the first barrier.

Next, as you start to get into computing and the community, you look around and realise, you are one of the few girls who have made it this far - and it's not even that far. That's not particularly encouraging, because you start questioning, do I belong here? Is there something wrong with me? Why aren't there more girls around me?

Then if you make it to the top (speaking from an outsider's perspective, because frankly, I'm not and I will probably never make it there), it's less about the fact that you made it there, but more like 'wow you're there DESPITE being a girl'. You're being celebrated for being exceptional ALTHOUGH you're a girl. Wouldn't you find that frustrating?

There's also another topic on girls DEI initiatives. Other than girls-only programmes, the Singapore computing-related olympiads (specifically the cybersec and informatics) have slots set aside for girls. I have openly criticised this because the girls who make it would have made it anyway without the DEI spots. And so, having such a thing only creates an opportunity for others to sort of discredit qualifying, attributing it to the special spot reserved for you.

This is not to say I don't support programmes targeting girls. Clearly we are discouraged from getting into computing and tech and STEM, so if the starting blocks are already unbalanced, having that additional push is the only way to level the playing field. However, my personal take is not to over-rely on these programmes or awards, since it makes it much easier for others to discredit and undermine your abilities if it's a 'girls-only' thing. I think that if you can 'play on the men's field' and have the mental fortitude for that kind of environment, then it is somewhat an obligation to go for it, and try to get as far as possible, because the gender gap will never close if we choose to avoid men altogether.

The issue I think girls-only programmes address (and should hence heavily focus on) is creating a warm and supportive environment for learning. Several issues mentioned above can be circumvented with this sort of welcoming culture when one first starts on their journey. Looking around, I find that those who have stayed despite the imbalanced gender ratio, and choose to actively push for change mainly have this in common: they had no idea about said ratio in their development, and hence found it unacceptable and become determined to make a change. I find this to hold true for myself, and strongly believe that the settings under which a girl picks up computing will heavily impact her confidence in it, the overall success, and whether she chooses to stay.


## Ft an ad by Mercedes-Benz, 2023

Source: "Be one of many" Official Ad Mercedes-Benz | International Women’s Day 2023 https://www.youtube.com/watch?v=VHqicS9C1NA
> #### Transcript:  
    > This is what it looks like to be exceptional; to stand out from the crowd; to make history.  
    > But what if women didn't have to be exceptional; what if they didn't have to be the first, the best or the only woman?  
...
When I first saw this on Instagram, I had no idea it was part of any sort of advertisement. I just resonated so much with this and really wanted to bring it up.

I think as much as I complain about the environment and the situation, it can sometimes be easy to forget what I want in the first place. As I try pushing for a sort of change, there should really be a vision or mission, just to put the end 'goal' into words. And yeah, honestly, I think all the girls in STEM just wants to be 'normal'. I don't find any meaning in being labelled as special and unique because of my gender, so really, as said in the ad, I do just want to be 'one of many'. I find it slightly hard to elaborate on this because I really think the video encapsulates it really well.
